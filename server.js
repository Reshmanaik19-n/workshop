...
// ----------------------------
let events = [
  { id: 1, name: "Synergia 2025 Kickoff", date: "2025-12-01", location: "Main Hall", description: "Opening event for Synergia" },
];

let bookings = [
  { id: 1, eventId: 1, participantName: "Alice Johnson", email: "alice@example.com" },
];
